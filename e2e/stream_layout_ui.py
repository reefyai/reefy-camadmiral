...
def main():
    ...
    with sync_playwright() as playwright:
        ...
        expect(page.get_by_role('combobox', name='Record', exact=True)).not_to_be_visible()
        expect(page.get_by_role('button', name='Save stream settings', exact=True)).to_be_visible()
        ...
        expect(page.locator('.stream-roles')).to_have_attribute('open', '')
